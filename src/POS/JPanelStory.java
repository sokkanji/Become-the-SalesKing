...
public class JPanelStory extends JPanel{
	...
	private Image Background = Toolkit.getDefaultToolkit().createImage("images/Storybackground_1.jpg");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(story_num==0) {
						if(add==story1_text.length) {
							add=0;
							++story_num;
							Background = Toolkit.getDefaultToolkit().createImage("images/cafe1.jpg"); //카페이미지로 변경
						}else {
				...
				if(story_num==1) {
					if(add==story1_1_text.length) {
						...
						story_num++;
						win.change("order");
						Background = Toolkit.getDefaultToolkit().createImage("images/cafe3.jpg"); //카페이미지로 변경
					}else {
				...
				if(story_num==3) {
					if(add==story3_text.length) {
						add=0;
						story_num++;
						Background = Toolkit.getDefaultToolkit().createImage("images/cafe4.jpg"); //카페이미지로 변경
						win.change("order");
					}else {
